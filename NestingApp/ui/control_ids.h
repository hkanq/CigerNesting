...
constexpr int buttonOpen = 1001;
constexpr int buttonSave = 1002;
constexpr int buttonStart = 1003;
constexpr int buttonStop = 1004;
constexpr int buttonCorelConnect = 1005;
constexpr int buttonCorelExport = 1006;

constexpr int editSheetWidth = 2001;
