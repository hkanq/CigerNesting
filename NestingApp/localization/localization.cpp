...
constexpr TextTable turkishTexts{
    ...
    L"Süre Limiti (sn)",
    L"CPU Çekirdeği",
    L"Maksimum / Tüm çekirdekler",
    L"çekirdek",
    L"Faz",
    L"Geçerli Strateji",
    L"Aktif Hamleler",
    L"Son Hamle",
    L"En İyi Güncellendi",
    L"Çarpışma",
    L"Doluluk",
    L"Dosya Aç",
    ...
    L"Delik Doldurma",
    L"Girinti Doldurma",
    L"Küçük Parça Doldurma",
    L"Yeniden Düzenleme",
    L"Takas",
    L"İtme Zinciri",
    L"Küme Yeniden Paketleme",
    L"Bölge Yeniden Paketleme",
    L"Kaçış",
    L"Frontier",
    L"Aynalama",
    L"Ultra İnce Ayar",
